...
// Original NPM package: https://www.npmjs.com/package/fractional-indexing
// Copied package content here because of module incompatibility
 ...
 * a and b.
 */
export function generateNKeysBetween(a: string | null, b: string | null, n: number, digits = BASE_62_DIGITS): string[] {
    if (n === 0) {
        return [];
    }
    if (n === 1) {
